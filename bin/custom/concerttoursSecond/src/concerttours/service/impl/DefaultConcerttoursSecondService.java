...
public class DefaultConcerttoursSecondService implements ConcerttoursSecondService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcerttoursSecondService.class);
	...
	{
		return DefaultConcerttoursSecondService.class.getResourceAsStream("/concerttoursSecond/sap-hybris-platform.png");
	}
