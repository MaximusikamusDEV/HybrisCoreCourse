 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new concerttours.ConcerttoursSecondStandalone().run();"
 * </code> From eclipse, just run as Java Application. Note that you maybe need to add all other projects like
 * ext-commerce, ext-pim to the Launch configuration classpath.
 */
public class ConcerttoursSecondStandalone
{
	/**
	...
	{
		new ConcerttoursSecondStandalone().run();
	}
